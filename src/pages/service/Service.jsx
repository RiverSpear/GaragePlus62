                ...
                <div className='flex flex-wrap justify-center gap-10'>
                    {
                        articles.map((article) => (
                            <Link to={`/servis/${article.fields.slug}`} key={article.sys.id} className="flex flex-col justify-between gap-5 bg-white p-10 rounded-2xl hover:shadow-xl hover:shadow-gray-200 hover:scale-[1.02] duration-200 w-[375px]">
