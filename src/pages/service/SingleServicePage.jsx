                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-10'>
                        {singleArticles.fields.detailService.map(
                            (detailService, index) => (
                                <div
                                    key={index}
                                    className='flex flex-col items-center gap-14 sm:gap-20 bg-white px-10 py-14 rounded-2xl shadow-lg'
                                >
                                    <div className='flex flex-col items-center gap-5'>
                                        <div className='text-center'>
                                            <p className='worksans-600 text-lg lg:text-2xl'>
                                                {detailService.fields.tier}
                                            </p>
                                            <p className='worksans-500 text-gray-700'>
                                                {
                                        ...
                                        {detailService.fields.servicePart.map(
                                            (_, index) => (
                                                ...
                                                >
                                                    ...
                                                    <p className='worksans-500 text-gray-600'>
                                                        {
                                                            detailService.fields
                                                                .servicePart[
                                                                index
