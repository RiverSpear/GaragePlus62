...
const ListServiceModel = ({article}) => {
    const {slug, showOnHomepage, headlinePhoto, servicePackName, vehicle, detailDescription} = article.fields
        ...
        <>
            {
                !showOnHomepage ? ( 
                    ...
                    <Link to={`/service/${slug}`} className='flex flex-col bg-white shadow-[0_25px_50px_-25px_rgba(148,163,184,0.5)] hover:shadow-[0_25px_50px_-15px_rgba(148,163,184,0.5)] hover:scale-105 duration-200 rounded-xl w-[275px] sm:w-[300px]'>
...
export default ListServiceModel