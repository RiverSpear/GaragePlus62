        ...
        <>
            <div className='flex flex-col gap-44'>
                ...
                <div className='flex flex-col items-center gap-10 px-10 md:px-28'>
                    ...
                    <ListService/>
                    <Link to='/service'>
                        <Ripples color="rgba(244,244,244,.3)" during={1200} className='flex items-center gap-5 worksans bg-amber-500 hover:bg-amber-400 text-white w-fit rounded-full px-7 py-4 duration-200'>
                            Servis
