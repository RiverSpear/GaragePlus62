                    ...
                    <div className='flex flex-col items-center gap-20'>
                        <div className='flex flex-col items-center gap-5 text-center px-10 lg:px-32 z-10'>
                            ...
                            <p className='worksans text-slate-500 w-full sm:w-3/4 md:w-1/2 text-center leading-7'>
                                Kunjungi bengkel kami yang mudah dijangkau dari
                                lokasi anda demi mendapatkan layanan terbaik
                        ...
                        <div className='flex flex-wrap justify-center gap-10 px-0 md:px-20 xl:px-32'>
                            {articles.map((article, index) => (
                                <div
                                    key={index}
                                    className='flex flex-col gap-7 bg-white p-5 md:p-8 rounded-2xl shadow-lg w-[375px] md:w-[500px] duration-200'
                                >
