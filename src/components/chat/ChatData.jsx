...
export const ChatData = ({chat}) => {
    ...
    return (
        <>
            <span className='fixed bottom-10 right-10 z-10 bg-white p-3 rounded-full shadow-lg hover:shadow-md shadow-slate-300 cursor-pointer duration-200' onClick={() => setPopup(true)}>
            ...
            <div className={`fixed z-10 inset-0 bg-black/50 duration-200 ${popup ? "h-screen visible pt-20 sm:pt-32 opacity-100" : "h-0 invisible pt-0 opacity-0"}`}>
